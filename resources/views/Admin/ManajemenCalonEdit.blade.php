...
<body>
    ...
    <section class="content">
        <div class="subheader">
            <h3 class="subheader-title">Edit Candidate</h3>
        </div>
        ...
        <form id="editCandidateForm" action="{{ route('calons.update', $calon->idcalon) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
                    ...
                    <tr>
                        <td>
                            ...
                            <div id="previewKetua" class="mt-2">
                                @if ($calon->wajahketua)
                                    <img src="{{ asset('storage/' . $calon->wajahketua) }}" class="img-thumbnail" style="max-width: 200px;">
                                @else
                        ...
                        <td>
                            ...
                            <div id="previewSekretaris" class="mt-2">
                                @if ($calon->wajahsekretaris)
                                    <img src="{{ asset('storage/' . $calon->wajahsekretaris) }}" class="img-thumbnail" style="max-width: 200px;">
                                @else
                                    <p>No image uploaded.</p>
                                @endif
                            </div>
                        ...
                        <td>
                            ...
                            <div id="previewBendahara" class="mt-2">
                                @if ($calon->wajahbendahara)
                                    <img src="{{ asset('storage/' . $calon->wajahbendahara) }}" class="img-thumbnail" style="max-width: 200px;">
                                @else
                                    <p>No image uploaded.</p>
                                @endif
                            </div>
            ...
            <button type="submit" class="btn btn-primary" onclick="confirmEdit(event)">Update Candidate</button>
        </form>
    </section>
